...
function HomeBrand(){
    ...
    return(
        <div className="app-container">
            ...
            <Modal title="Select Brand" visible={selectDialogVisible} style={{minWidth:'500px'}} width="40%" onCancel={()=>setSelectDialogVisible(false)} onOk={handleSelectDialogConfirm}>
