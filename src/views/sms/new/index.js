...
import {newProductServices} from 'services/newProduct';
...
function HomeNew(){
    ...
    const handleSelectDialogConfirm=()=>{
        ...
        confirm({
            ...
            okType:'primary',
            onOk(){
                newProductServices.createNewProduct(selectProducts).then(response=>{
    ...
    const handleUpdateSort=()=>{
        confirm({
            ...
            okType:'primary',
            onOk(){
                newProductServices.updateNewProductSort(sortDialogData).then(response=>{
    ...
    const getList=()=>{
        setListLoading(true);
        newProductServices.fetchList(listQuery).then(response=>{
    ...
    const updateRecommendStatus=(ids,status)=>{
        confirm({
            ...
            onOk(){
                ...
                newProductServices.updateRecommendStatus(params).then(response=>{
                    getList();
    ...
    const deleteProduct=(ids)=>{
        confirm({
            ...
            onOk(){
                ...
                params.append("ids",ids);
                params.append("recommendStatus",status);
                newProductServices.deleteNewProduct(params).then(response=>{
                    getList();
    ...
    return(
        <div className="app-container">
                ...
                <div style={{marginTop:'15px'}}>
                    <Form layout="inline" size="small" labelCol={{span:10}}>
                        <Form.Item label="Name: ">
                            <Input style={{width:'200px'}}  value={listQuery.productName} name="productName" onChange={(e)=>setListQuery({...listQuery,productName:e.target.value})} 
            ...
            <div className="table-container">
                <Table rowSelection={{...rowSelection}} {...tableStatus} rowKey="id" dataSource={list} style={{width:'100%'}} loading={listLoading}>
            ...
            <Modal title="Select Product" visible={selectDialogVisible} width="50%" onCancel={()=>setSelectDialogVisible(false)} onOk={handleSelectDialogConfirm}>
                ...
                <Table rowKey="productSn" rowSelection={{...dialogRowSelection}}  dataSource={dialogData.list} {...dialogTableStatus}>
